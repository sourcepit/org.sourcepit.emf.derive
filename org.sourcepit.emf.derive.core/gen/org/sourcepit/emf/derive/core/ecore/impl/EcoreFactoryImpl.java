...
public class EcoreFactoryImpl extends EFactoryImpl implements EcoreFactory {
   ...
   public EObject create(EClass eClass) {
      switch (eClass.getClassifierID()) {
         case EcorePackage.ECORE_DERIVATION_CONFIGURATION :
            return createEcoreDerivationConfiguration();
         default :
    ...
    * @generated
    */
   public EcoreDerivationConfiguration createEcoreDerivationConfiguration() {
      EcoreDerivationConfigurationImpl ecoreDerivationConfiguration = new EcoreDerivationConfigurationImpl();
      return ecoreDerivationConfiguration;
   }
