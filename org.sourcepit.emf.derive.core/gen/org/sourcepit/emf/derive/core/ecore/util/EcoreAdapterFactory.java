...
public class EcoreAdapterFactory extends AdapterFactoryImpl {
   ...
   protected EcoreSwitch<Adapter> modelSwitch = new EcoreSwitch<Adapter>() {
      @Override
      public Adapter caseEcoreDerivationConfiguration(EcoreDerivationConfiguration object) {
         return createEcoreDerivationConfigurationAdapter();
      }

      @Override
      public <T> Adapter caseDerivationConfiguration(DerivationConfiguration<T> object) {
         return createDerivationConfigurationAdapter();
      }
    ...
    * '{@link org.sourcepit.emf.derive.core.ecore.EcoreDerivationConfiguration <em>Derivation Configuration</em>}'.
    * <!-- begin-user-doc -->
    ...
    * @generated
    */
   public Adapter createEcoreDerivationConfigurationAdapter() {
      return null;
   }

   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.emf.derive.core.DerivationConfiguration
    ...
    * @generated
    */
   public Adapter createDerivationConfigurationAdapter() {
      return null;
   }
